...
# 5. 出力 (Outputs)
# ==============================================================================
# importされた時点でこれらのexportが実行され、CLI上に表示されます
pulumi.export("bq_dataset_id", dataset.dataset_id)
pulumi.export("bq_table_id", table.table_id)
pulumi.export("bq_table_full_path", pulumi.Output.concat(dataset.project, ".", dataset.dataset_id, ".", table.table_id))